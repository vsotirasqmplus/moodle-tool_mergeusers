...
return [
        ...
        'compoundindexes' => [
                ...
                'role_assignments' => [
                        'userfield' => ['userid'],
                        'otherfields' => ['contextid', 'roleid'], // C mdl_roleassi_useconrol_ix (not unique).
                ],
                'user_lastaccess' => [
                        'userfield' => ['userid'],
                        'otherfields' => ['courseid'], // 0 mdl_userlast_usecou_ui (unique).
                ],
                'quiz_attempts' => [
                        'userfield' => ['userid'],
                        'otherfields' => ['quiz', 'attempt'], // 0 mdl_quizatte_quiuseatt_uix (unique).
                ],
                'cohort_members' => [
                        'userfield' => ['userid'],
                        'otherfields' => ['cohortid'],
                ],
                'certif_completion' => [  // 0 mdl_certcomp_ceruse_uix (unique).
                        'userfield' => ['userid'],
                        'otherfields' => ['certifid'],
                ],
                'course_modules_completion' => [ // 0 mdl_courmoducomp_usecou_uix (unique).
                        'userfield' => ['userid'],
                        'otherfields' => ['coursemoduleid'],
                ],
                'scorm_scoes_track' => [ // 0 mdl_scorscoetrac_usescosco_uix (unique).
                        'userfield' => ['userid'],
